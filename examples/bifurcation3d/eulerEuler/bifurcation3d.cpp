...
#define ADDESCRIPTOR StokesDragAdvectionDiffusionD3Q7Descriptor
                ...
                Timer<double>& timer)
{
  ...
  SuperVTKwriter3D<T> vtkWriter("bifurcation3d_fluid");
  SuperVTKwriter3D<T> vtkWriterAD("bifurcation3d_particle");
  ...
  vtkWriterAD.addFunctor(particles);
  vtkWriterAD.addFunctor(extField);
...
int main(int argc, char* argv[])
{
  ...
  StokesDragAdvectionDiffusionBGKdynamics<T, ADDESCRIPTOR> bulkDynamicsAD (omegaAD, instances::getBulkMomenta<T,ADDESCRIPTOR>());
  ...
  StokesDragCouplingGenerator3D<T,NSDESCRIPTOR> coupling(converter, radius, partRho, ADDESCRIPTOR<T>::ExternalField::velocityBeginsAt);
