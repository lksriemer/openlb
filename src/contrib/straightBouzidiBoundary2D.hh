 ...
 */
#ifndef STRAIGHT_BOUZIDI_BOUNDARY_2D_HH
#define STRAIGHT_BOUZIDI_BOUNDARY_2D_HH
...
////////// YoungBoundaryManager2D /////////////////////////////////////////

template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
Momenta<T,Lattice>*
    YoungBoundaryManager2D<T,Lattice,MixinDynamics>::getVelocityBoundaryMomenta()
{
...
template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
Dynamics<T,Lattice>* YoungBoundaryManager2D<T,Lattice,MixinDynamics>::
    getVelocityBoundaryDynamics(T omega, Momenta<T,Lattice>& momenta)
{
    return new YoungDynamics<T,Lattice, MixinDynamics, direction, orientation>(omega, momenta);
}

template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
PostProcessorGenerator2D<T,Lattice>*
    YoungBoundaryManager2D<T,Lattice,MixinDynamics>::
        getVelocityBoundaryProcessor(int x0, int x1, int y0, int y1)
{
    return 0;
}
...
template<int direction, int orientation>
Momenta<T,Lattice>*
    YoungBoundaryManager2D<T,Lattice,MixinDynamics>::getPressureBoundaryMomenta()
{
...
Momenta<T,Lattice>*
    YoungBoundaryManager2D<T,Lattice,MixinDynamics>::getExternalVelocityCornerMomenta()
{
...
template<int xNormal, int yNormal>
Momenta<T,Lattice>*
    YoungBoundaryManager2D<T,Lattice,MixinDynamics>::getInternalVelocityCornerMomenta()
{
...
template<int xNormal, int yNormal>
PostProcessorGenerator2D<T,Lattice>*
    YoungBoundaryManager2D<T,Lattice,MixinDynamics>::getInternalVelocityCornerProcessor
        (int x, int y)
{
    return 0;
}
...
OnLatticeBoundaryCondition2D<T,Lattice>* createYoungBoundaryCondition2D(BlockStructure2D<T,Lattice>& block) {
    return new BoundaryConditionInstantiator2D <
                   T, Lattice,
                   YoungBoundaryManager2D<T,Lattice, MixinDynamics> > (block);
}
