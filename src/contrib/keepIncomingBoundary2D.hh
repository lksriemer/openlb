 ...
 */
#ifndef KEEP_INCOMING_BOUNDARY_2D_HH
#define KEEP_INCOMING_BOUNDARY_2D_HH
...
class KeepIncomingBoundaryManager2D {
public:
...
////////// KeepIncomingBoundaryManager2D /////////////////////////////////////////

template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
Momenta<T,Lattice>*
    KeepIncomingBoundaryManager2D<T,Lattice,MixinDynamics>::getVelocityBoundaryMomenta()
{
...
template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
Dynamics<T,Lattice>* KeepIncomingBoundaryManager2D<T,Lattice,MixinDynamics>::
    getVelocityBoundaryDynamics(T omega, Momenta<T,Lattice>& momenta)
{
    return new KeepIncomingDynamics<T,Lattice, MixinDynamics, direction, orientation>(omega, momenta);
}

template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
PostProcessorGenerator2D<T,Lattice>*
    KeepIncomingBoundaryManager2D<T,Lattice,MixinDynamics>::
        getVelocityBoundaryProcessor(int x0, int x1, int y0, int y1)
{
    return 0;
}
...
template<int direction, int orientation>
Momenta<T,Lattice>*
    KeepIncomingBoundaryManager2D<T,Lattice,MixinDynamics>::getPressureBoundaryMomenta()
{
...
Momenta<T,Lattice>*
    KeepIncomingBoundaryManager2D<T,Lattice,MixinDynamics>::getExternalVelocityCornerMomenta()
{
...
template<int xNormal, int yNormal>
Momenta<T,Lattice>*
    KeepIncomingBoundaryManager2D<T,Lattice,MixinDynamics>::getInternalVelocityCornerMomenta()
{
...
template<int xNormal, int yNormal>
PostProcessorGenerator2D<T,Lattice>*
    KeepIncomingBoundaryManager2D<T,Lattice,MixinDynamics>::getInternalVelocityCornerProcessor
        (int x, int y)
{
    return 0;
}
...
template<int direction, int orientation>
Momenta<T,Lattice>*
    S1BoundaryManager2D<T,Lattice,MixinDynamics>::getVelocityBoundaryMomenta()
{
    return new BasicDirichletBM<T,Lattice, VelocityBM, direction,orientation>;
}
...
template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
Dynamics<T,Lattice>* S1BoundaryManager2D<T,Lattice,MixinDynamics>::
    getVelocityBoundaryDynamics(T omega, Momenta<T,Lattice>& momenta)
{
    return new S1Dynamics<T,Lattice, MixinDynamics, direction, orientation>(omega, momenta);
}

template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
PostProcessorGenerator2D<T,Lattice>*
    S1BoundaryManager2D<T,Lattice,MixinDynamics>::
        getVelocityBoundaryProcessor(int x0, int x1, int y0, int y1)
{
    return 0;
}
...
template<int direction, int orientation>
Momenta<T,Lattice>*
    S1BoundaryManager2D<T,Lattice,MixinDynamics>::getPressureBoundaryMomenta()
{
    return new BasicDirichletBM<T,Lattice, PressureBM, direction,orientation>;
} 
template<typename T, template<typename U> class Lattice, class MixinDynamics>
...
template<int xNormal, int yNormal>
Momenta<T,Lattice>*
    S1BoundaryManager2D<T,Lattice,MixinDynamics>::getExternalVelocityCornerMomenta()
{
    return new FixedVelocityBM<T,Lattice>;
}
...
template<int xNormal, int yNormal>
Momenta<T,Lattice>*
    S1BoundaryManager2D<T,Lattice,MixinDynamics>::getInternalVelocityCornerMomenta()
{
    return new InnerCornerVelBM2D<T,Lattice, xNormal,yNormal>;
}
...
template<int xNormal, int yNormal>
PostProcessorGenerator2D<T,Lattice>*
    S1BoundaryManager2D<T,Lattice,MixinDynamics>::getInternalVelocityCornerProcessor
        (int x, int y)
{
    return 0;
}
...
OnLatticeBoundaryCondition2D<T,Lattice>*
    createKeepIncomingBoundaryCondition2D(BlockStructure2D<T,Lattice>& block)
{
    return new BoundaryConditionInstantiator2D <
                   T, Lattice,
                   KeepIncomingBoundaryManager2D<T,Lattice, MixinDynamics> > (block);
}

template<typename T, template<typename U> class Lattice, typename MixinDynamics>
OnLatticeBoundaryCondition2D<T,Lattice>*
    createS1BoundaryCondition2D(BlockStructure2D<T,Lattice>& block)
{
    return new BoundaryConditionInstantiator2D <
                   T, Lattice,
                   S1BoundaryManager2D<T,Lattice, MixinDynamics> > (block);
}
