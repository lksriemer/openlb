...
template class IndicatorF1D<bool,double>;

template class IndicatorF2D<bool,double>;

template class IndicatorIdentity2D<bool,double>;

template class IndicatorF3D<bool,double>;

template class IndicatorIdentity3D<bool,double>;
