...
#include "definition/common.h"
#include "definition/mrt.h"
#include "definition/rtlbm.h"
#include "definition/cum.h"
...
using D2 = SPATIAL_DESCRIPTOR<2,FIELDS...>;

template <typename... FIELDS>
using D3 = SPATIAL_DESCRIPTOR<3,FIELDS...>;
...
using DualForcedD3Q19Descriptor = D3Q19<FORCE,opti::F,opti::DJDF>;

using DualForcedMRTD3Q19Descriptor = D3Q19<tag::MRT,FORCE,COORDINATE,opti::F,opti::DJDF>;

using DualPorousD2Q9Descriptor  = D2Q9<POROSITY,opti::F,opti::DJDF>;
using DualPorousD3Q19Descriptor = D3Q19<POROSITY,opti::F,opti::DJDF>;
