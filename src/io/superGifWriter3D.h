...
#ifndef SUPER_GIF_WRITER_3D_H
#define SUPER_GIF_WRITER_3D_H
...
class SuperGifWriter3D {
public:
  SuperGifWriter3D(std::string const& map);
  void write( SuperLatticeF3D<T,DESCRIPTOR>& f, std::vector<int> normal );
...
//  std::vector<int> vecV( std::vector<int> normal );
  ...
  void setFrameExt( SuperLatticeF3D<T,DESCRIPTOR>& f, std::vector<int> normal );
  //   
  void writeXYplane( SuperLatticeF3D<T,DESCRIPTOR>& f );
  void writeXZplane( SuperLatticeF3D<T,DESCRIPTOR>& f );
  void writeYZplane( SuperLatticeF3D<T,DESCRIPTOR>& f );
  int _extNx;
  int _extNy;
  int _extNz;
