...
template <typename T>
PiecewiseFunction<T> generateMandelbrotRed() {
    T p0  = (T) 0.;
    T p2  = (T) 3./8.;
    T p3  = (T) 5./8.;
    T p4  = (T) 7./8.;
...
template <typename T>
PiecewiseFunction<T> generateMandelbrotGreen() {
    T p0  = (T) 0.;
    T p1  = (T) 1./8.;
    T p2  = (T) 3./8.;
    T p3  = (T) 5./8.;
...
template <typename T>
PiecewiseFunction<T> generateMandelbrotBlue() {
    T pm1 = (T) -1./8.;
    T p0  = (T) 0.;
    T p1  = (T) 1./8.;
    T p2  = (T) 3./8.;
...
ColorMap<T> generateMap(std::string mapName) {
    ...
    else if (mapName == "mandelbrot") {
        return ColorMap<T> (
                generateMandelbrotRed<T>(),
                generateMandelbrotGreen<T>(),
                generateMandelbrotBlue<T>() );
    }
    return ColorMap<T> (
            generateLeeLooRed<T>(),
            generateLeeLooGreen<T>(),
