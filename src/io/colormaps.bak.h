...
template <typename T> PiecewiseFunction<T> generateMandelbrotRed();
template <typename T> PiecewiseFunction<T> generateMandelbrotGreen();
template <typename T> PiecewiseFunction<T> generateMandelbrotBlue();
