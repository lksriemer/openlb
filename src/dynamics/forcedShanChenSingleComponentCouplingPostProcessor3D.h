...
#ifndef FORCED_SHAN_CHEN_SINGLE_COMPONENT_COUPLING_POST_PROCESSOR_3D_H
#define FORCED_SHAN_CHEN_SINGLE_COMPONENT_COUPLING_POST_PROCESSOR_3D_H
...
class ForcedShanChenSingleComponentCouplingPostProcessor3D : public LocalPostProcessor3D<T,Lattice> {
public:
...
template<typename T, template<typename U> class Lattice>
class ForcedShanChenSingleComponentCouplingGenerator3D : public LatticeCouplingGenerator3D<T,Lattice> {
public:
  ForcedShanChenSingleComponentCouplingGenerator3D(int x0_, int x1_, int y0_, int y1_, int z0_, int z1_, T G_, std::vector<T> rho0_);
