...
public:
    ...
    void initializeGPC(std::size_t order, std::size_t nq,
    ...
    void initializeMonteCarlo(std::size_t numSamples, const std::vector<Distribution<T>>& distributions, unsigned int seed);
    void initializeMonteCarlo(std::size_t numSamples, Distribution<T> distribution, unsigned int seed );

    void initializeQuasiMonteCarlo(std::size_t numSamples,
                                    Distribution<T> distribution,
