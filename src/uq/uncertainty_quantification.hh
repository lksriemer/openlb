...
template<typename T>
void UncertaintyQuantification<T>::initializeMonteCarlo(std::size_t numSamples, const std::vector<Distribution<T>>& distributions, unsigned int seed) {
...
template<typename T>
void UncertaintyQuantification<T>::initializeMonteCarlo(std::size_t numSamples, Distribution<T> distribution, unsigned int seed) {
    this->numSamples = numSamples;
    this->randomNumberDimension = 1;
    this->distributions = {distribution};
...
template<typename T>
void UncertaintyQuantification<T>::initializeLatinHypercubeSampling(std::size_t numSamples, std::size_t randomNumberDimension) {
    this->numSamples = numSamples;
