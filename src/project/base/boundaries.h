...
class GenericBoundaryMomenta : public Momenta<T,Lattice> {
public:
    typedef T VelocityT[Lattice<T>::d];
    typedef T StressT[util::TensorVal<Lattice<T> >::n];
public:
    GenericBoundaryMomenta();
    ...
    void computeStress(T pi[util::TensorVal<Lattice<T> >::n] ) const;
...
template<typename T, template<typename U> class Lattice>
class StressInterpolationBM
    : virtual public DirichletBoundaryMomenta<T,Lattice>
{
public:
    ...
    virtual void computeStress (
            ...
            T pi[util::TensorVal<Lattice<T> >::n] ) const;
    T& operator[] (int iPi) {
        OLB_PRECONDITION(iPi<util::TensorVal<Lattice<T> >::n);
        return piVal[iPi];
    }
private:
    T piVal[util::TensorVal<Lattice<T> >::n];
};
...
template<typename T, template<typename U> class Lattice,
         ...
         class HydroBM,
         int direction, int orientation>
class StressInterpolationDirichletBM
    : public StressInterpolationBM<T, Lattice>,
