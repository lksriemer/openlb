...
private:
    ...
    T bulkXderiv(int iX, int iY, int iZ, int iD,
                 TensorField3D<T,3> const& field) const;
    T bulkYderiv(int iX, int iY, int iZ, int iD,
                 TensorField3D<T,3> const& field) const;
    T bulkZderiv(int iX, int iY, int iZ, int iD,
                 TensorField3D<T,3> const& field) const;
    T bulkDeriv(int iX, int iY, int iZ, int iAlpha, int iBeta,
                TensorField3D<T,3> const& field) const;
    ...
    T boundaryXderiv(int iX, int iY, int iZ, int iD,
                     TensorField3D<T,3> const& field) const;
    T boundaryYderiv(int iX, int iY, int iZ, int iD,
                     TensorField3D<T,3> const& field) const;
    T boundaryZderiv(int iX, int iY, int iZ, int iD,
                     TensorField3D<T,3> const& field) const;
    T boundaryDeriv(int iX, int iY, int iZ, int iAlpha, int iBeta,
                    TensorField3D<T,3> const& field) const;
