...
private:
    ...
    T bulkXderiv(int iX, int iY, int iD,
                 TensorField2D<T,2> const& field) const;
    T bulkYderiv(int iX, int iY, int iD,
                 TensorField2D<T,2> const& field) const;
    T bulkDeriv(int iX, int iY, int iAlpha, int iBeta,
                TensorField2D<T,2> const& field) const;
    T bulkStrain(int iX, int iY, int iAlpha, int iBeta) const;
    T bulkDivRhoU(int iX, int iY) const;
    T bulkPoisson(int iX, int iY) const;
    T boundaryXderiv(int iX, int iY, int iD,
                     TensorField2D<T,2> const& field) const;
    T boundaryYderiv(int iX, int iY, int iD,
                     TensorField2D<T,2> const& field) const;
    T boundaryDeriv(int iX, int iY, int iAlpha, int iBeta,
                    TensorField2D<T,2> const& field) const;
