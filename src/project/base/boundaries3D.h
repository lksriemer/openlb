 ...
 */
#ifndef BOUNDARIES_3D_H
#define BOUNDARIES_3D_H
...
class ConcaveEdgeVelBM3D : public DirichletBoundaryMomenta<T,Lattice>
{
public:
...
class ConcaveCornerVelBM3D : public DirichletBoundaryMomenta<T,Lattice>
{
public:
    /// Default Constructor: initialization to zero
    ConcaveCornerVelBM3D();
    /// Constructor with boundary initialization
    ConcaveCornerVelBM3D(const T u_[Lattice<T>::d]);
