...
template double computeMin<double,ScalarField2D> (
        ScalarField2D<double> const& field );
template double computeMax<double,ScalarField2D> (
        ScalarField2D<double> const& field );
template double computeAverage<double,ScalarField2D> (
        ScalarField2D<double> const& field );
template double computeRMS<double,ScalarField2D> (
        ScalarField2D<double> const& field );
template double computeNormSqr<double,ScalarField2D> (
        ScalarField2D<double> const& field );
