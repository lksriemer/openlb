...
template double computeMin<double,ScalarField3D> (
        ScalarField3D<double> const& field );
template double computeMax<double,ScalarField3D> (
        ScalarField3D<double> const& field );
template double computeAverage<double,ScalarField3D> (
        ScalarField3D<double> const& field );
template double computeRMS<double,ScalarField3D> (
        ScalarField3D<double> const& field );
template double computeNormSqr<double,ScalarField3D> (
        ScalarField3D<double> const& field );
