...
void StatisticsPostProcessor2D<T,Lattice>::
    subscribeReductions(BlockLattice2D<T,Lattice>& blockLattice,
                        Reductor<T>* reductor)
{
...
PostProcessor2D<T,Lattice>*
    StatPPGenerator2D<T,Lattice>::generate (
...
void StatisticsPostProcessor3D<T,Lattice>::
    subscribeReductions(BlockLattice3D<T,Lattice>& blockLattice,
                        Reductor<T>* reductor)
{
    reductor -> subscribeAverage (
                    blockLattice.getStatistics().getNumCells(),
...
PostProcessor3D<T,Lattice>*
    StatPPGenerator3D<T,Lattice>::generate (
...
PostProcessorGenerator3D<T,Lattice>*
    StatPPGenerator3D<T,Lattice>::clone() const
{
