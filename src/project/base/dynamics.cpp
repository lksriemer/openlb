...
namespace olb {
    ...
    namespace instances {
        ...
        template BulkMomenta<double, descriptors::D2Q9Descriptor>&
            getBulkMomenta();

        template BounceBack<double, descriptors::D2Q9Descriptor>&
            getBounceBack();

        template NoDynamics<double, descriptors::D2Q9Descriptor>&
            getNoDynamics();

        template BulkMomenta<double, descriptors::D3Q19Descriptor>&
            getBulkMomenta();

        template BounceBack<double, descriptors::D3Q19Descriptor>&
            getBounceBack();

        template NoDynamics<double, descriptors::D3Q19Descriptor>&
            getNoDynamics();
    }
