 ...
 */
#ifndef BOUNDARIES_2D_HH
#define BOUNDARIES_2D_HH
...
////////////////////// Class ConcaveCornerVelBM2D ///////////////

template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::ConcaveCornerVelBM2D()
{ }
...
template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
T ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::computeRho (
...
template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
void ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::computeU (
...
template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
void ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::computeJ (
        Cell<T,Lattice> const& cell,
...
template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
void ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::defineRho (
        Cell<T,Lattice>& cell, T rho )
{ }

template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
void ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::defineU (
        Cell<T,Lattice>& cell,
...
template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
void ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::defineAllMomenta (
        Cell<T,Lattice>& cell,
...
template<typename T, template<typename U> class Lattice,
         int normalX, int normalY>
void ConcaveCornerVelBM2D<T,Lattice,normalX,normalY>::computeStress (
            Cell<T,Lattice> const& cell,
            T rho, const T u[Lattice<T>::d],
