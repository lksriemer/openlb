...
SuperExternal2D<T, Lattice>::SuperExternal2D(SuperGeometry2D<T>& superGeometry, SuperLattice2D<T, Lattice>& sLattice, int offset, int size, int overlap)
: SuperStructure2D<T>(superGeometry.getCuboidGeometry(), superGeometry.getLoadBalancer()), _offset(offset), _size(size), _overlap(overlap), _sLattice(sLattice) {
