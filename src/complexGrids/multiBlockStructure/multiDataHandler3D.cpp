...
#include "multiDataHandler3D.hh"
#include "core/latticeDescriptors.h"
#include "core/latticeDescriptors.hh"

namespace olb {

    template class SerialDataHandler3D<double, descriptors::D3Q19Descriptor>;

#ifdef PARALLEL_MODE_MPI
    template class ParallelDataHandler3D<double, descriptors::D3Q19Descriptor>;
#endif
