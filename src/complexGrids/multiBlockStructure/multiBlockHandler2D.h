...
struct MultiBlockHandler2D {
    ...
    virtual int locateLocally(int iX, int iY, std::vector<int>& foundId, int guess=0) const =0;
};
...
public:
    ...
    virtual int locateLocally(int iX, int iY, std::vector<int>& foundId, int guess=0) const;
private:
